...
function SLL2(head = null) {
    ...
    this.removeNode = function(node){
        ...
        console.log("Node not in the list!");
        return this;
    }
}
...
sl1.insertNode(node1).insert(-1).insert(2).insert(-3).insert(6)//.insert(-2).insert(5);
// console.log(sl1.secondToLast());
// console.log(node1.next);
sl1.removeNode(node1);
sl1.printAll();