...
var sl1 = new SLL2();
var sl2 = new SLL2();
sl1.insert("A").insert("B").insert("C").insert("D");
sl1.reverse().printAll().reverse().printAll();//reverse twice to make it look the same
sl2.insert("A").insert("B").insert("B").insert("A");
console.log(sl2.isPal());//true
